# Cycle 4 — Framework Skeleton + Work PoC Proposal

**Weeks:** 7–8 (2026-07-20 → 2026-08-02)
**Status:** pending
**Ship:** Playwright TS framework v0 in a new public repo; Sagacity Playwright PoC proposal sent to team.
...
- `playwright-ts-framework` repo public with CI badge green.
- PoC proposal sent (the proposal IS the artifact — implementation may extend beyond).
